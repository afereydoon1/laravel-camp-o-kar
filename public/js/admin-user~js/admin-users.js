(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/admin-user~js/admin-users"],{
  ...
  methods: {
    ...
    getUsers: function getUsers() {
      ...
      axios.get("/api/admin/users?page=".concat(page)).then(function (_ref) {
        var data = _ref.data;
        _this2.users = data;
        window.history.pushState('users', 'Users', "/admin/user?page=".concat(page));
      });
    }
  }
});
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            [_c("i", { staticClass: "fa fa-user-plus" }), _vm._v(" کاربر جدید")]
          )
        ],
        1
      ),
                  ...
                  return _c("tr", { key: user.id }, [
                    ...
                    _c("td", [
                      _vm._v(
                        "\n                            " +
                          _vm._s(
                            _vm.moment(user.created_at).format("jYY/jM/jD")
                          ) +
                          "\n                        "
                      )
                    ]),
