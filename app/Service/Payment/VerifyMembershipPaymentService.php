...
class VerifyMembershipPaymentService
{
    ...
    protected function checkVerifyRequest()
    {
        ...
        if ($this->verified_request['Status'] === 'success') {
            ...
            session()->flash('notify', [
                'title' => 'اشتراک ویژه را به درستی خریداری کردید',
            ...
            $this->response = redirect('/dashboard/membership');
        } else {
            session()->flash('notify', [
                'title' => 'مشکلی به وجود امد',
    ...
    protected function updatePayment(): void
    {
        ...
        $expire_at = $this->payment->paymentable->expire_at;
