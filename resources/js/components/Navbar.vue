    ...
    <div class="w-100" id="bg-navbar">
        <div class="container" >
            <nav class="row navbar navbar-expand-lg navbar-light">
                <router-link class="navbar-brand" :to="{ name: 'home' }">کمپ و کار</router-link>
                        ...
                        <template v-else>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" :class="dropDownShow">
                                    <router-link class="dropdown-item" :to="{ name: 'admin-dashboard' }" v-if="user.is_admin === 1">داشبورد ادمین</router-link>
                                    <router-link class="dropdown-item" :to="{ name: 'dashboard' }">داشبورد</router-link>
